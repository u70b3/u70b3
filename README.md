...
I work on the hard boundaries in open-source data systems—where query semantics meet
storage formats, asynchronous state becomes durable, and index algorithms become
production APIs.

- **Correctness and durability:** WAL generations and fencing, cache/object-store
  lifetimes, weak-memory concurrency, overflow, NULL semantics, and failure propagation.
...
Selected upstream contributions: 45 merged pull requests across 13 repositories.
